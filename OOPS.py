...
# Looks like real-life objects, Easy for beginners to follow
# 2.Reusable
# Write once, use many times, Example: one class → many objects
# 3.Organized
# Code is clean and structured, No messy long programs
# 4.Easy to Maintain
# If error comes → easy to fix,Changes won’t affect entire program, Code is divided into small parts(classes)
# 5.Scalable (for big projects)
# Used in real companies for large applications
# 6.Security (encapsulation) - You can hide important data and control access
# 7.Fexibility(polymorphism)
